...
(function ($, window, document, undefined)
{
    ...
    _easyinput.prototype = {
        ...
        judge: {
            ...
            "title": function (ei, v, p)
            {
                if (false == /^[\d|A-z|\u4E00-\u9FFF]{6,20}$/.test(v))
                    return ei._error("title");
                else
                    return ei._success_rule("title");
            },
            ...
            {
                if (false == /^(13[0-9]|15[012356789]|17[678]|18[0-9]|14[57])[0-9]{8}$/.test(v))
                    return ei._error("phone");
                else
                    return ei._success_rule("phone");

            },
            "nick": function (ei, v, p)
            {
                if (false == /^[A-z|\x00-\xff]{1,16}$/.test(v))
                    return ei._error("nick");
                else
                    return ei._success_rule("nick");

            },
            "name": function (ei, v, p)
            {
                if (false == /^[\u4E00-\u9FA5]{2,5}(?:·[\u4E00-\u9FA5]{2,5})*$/.test(v))
                    return ei._error("name");
                else
                    return ei._success_rule("name");
            },
